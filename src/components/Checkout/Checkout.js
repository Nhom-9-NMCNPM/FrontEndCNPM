      ...
      <div className="checkout-content row">
        <div className="main col-7">
          <div className="main-header">
            ...
            <ul className="breadcrumb" style={{ padding: ".35rem 1rem" }}>
            ...
            <form className="form" id="checkout-form">
              ...
              <div className="method">
                <div className="method-content">
                  <h3 className="method-title">Phương thức vận chuyển</h3>
                ...
                <div className="method-content">
                  <h3 className="method-title">Phương thức thanh toán</h3>
                  <p className="method-text">
        ...
        <div className="sidebar col-5">
          ...
          <div className="discount">
            <img src={voucher} alt=" " className="discount-icon" />
          ...
          {show && (
            <div className="discount-popup">
              ...
              <div className="discount-popup-containter">
                <div
                  className="discount-popup-header d-flex justify-content-between"
                  ...
                  <div className="discount-list-items">
                    {vouchers.map((voucher, index) => (
                      <div className="discount-item" key={index}>
                          ...
                          <div className="discoun-item__content">
                            <div className="discount-item__text">
                              ...
                              <div className="discount-item__condition">
                                Đơn Tối Thiểu ₫
                                {format_curency(voucher.condition)}
                              </div>
                            </div>
                        ...
                        {coupon === index && total < voucher.condition && (
                          <div className="discount-item__message">
                            Không đủ điều kiện áp dụng mã giảm giá này!
                          </div>
                        )}
                      </div>
                    ))}
                    ...
                    {vouchersPremium.map((voucher, indexPre) => (
                      <div className="discount-item" key={indexPre}>
                        <div
                          className="discount-item__main"
                          style={
                            indexPre === couponPre
                              ? point < voucher.condition
                                ? {
                                    background: "#a3423c",
                                    color: "white",
                                  }
                        ...
                        {couponPre === indexPre &&
                          point < voucher.condition && (
                            <div className="discount-item__message">
                              Số điểm tích lũy không đủ điều kiện áp dụng mã
                              giảm giá này!
                            </div>
                          )}
                      </div>
            ...
            <div className="payment-detail">
              ...
              <p className="payment-price">
                {format_curency(
                  parseInt((total * couponRate) / 100 + couponRatePre),
                  10
                )}
                đ
              </p>
            ...
            <div className="payment-detail">
              ...
              <p className="payment-price">
                {format_curency(
                  parseInt(
                    (total - (total * couponRate) / 100 - couponRatePre) / 100,
                    10
                  )
                )}
            ...
            <p className="freeship-content">
              Bạn được miễn phí giao hàng cho hóa đơn trên 699.000đ
            </p>
          </div>
          ...
          <div className="total-price-final">
            ...
            <p className="total-price-content">
              {format_curency(
                parseInt(total - (total * couponRate) / 100 - couponRatePre, 10)
              )}
              đ
            </p>
          </div>
          ...
          <div className="thankful-note">
            <p>
              EVA DE EVA ghi nhận đơn hàng và sẽ KIỂM TRA lại tình trạng sản
              phẩm trước khi confirm qua EMAIL. Do tình hình dịch bệnh nên thời
              gian chuyển phát chậm hơn so với bình thường, bạn vui lòng kiểm
              tra EMAIL và thông cảm cho sự chậm trễ của chúng tôi nhé!
            </p>
          </div>
        </div>
      </div>

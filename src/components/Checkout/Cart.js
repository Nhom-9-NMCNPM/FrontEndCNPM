      ...
      <div id="cart-selection">
        ...
        <div class="cart-content">
            ...
            <tbody>
              {cart.map((product, index) => (
                <tr key={index}>
                  ...
                  <td class="price">
                    {format_curency(
                      parseInt(product.price - (product.price * sale) / 100, 10)
                    )}
                  </td>
                  <td>
                    <div class="quantity-area">
                      ...
                      <div class="quantity-content">{product.count}</div>
                      <div
          ...
          <div class="checkout-note">
            ...
            <textarea name="note" id="note" cols="50" rows="8"></textarea>
            <ul class="promotion">
              <li>
                <img
